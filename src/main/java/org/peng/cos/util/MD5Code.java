...
public class MD5Code {
	...
	public static String getMD5FromBytes(byte[] source) {
		String s = null;
	...
	public String getMD5ofStr(String inbuf) {
		try {
			return getMD5FromBytes(inbuf.getBytes("utf-8"));
	...
	// This function produces weird results when input string contains some
	// non-latin characters
	@Deprecated
	public String getMD5ofStrOldWeb(String inbuf) {
		md5Init();
		try {
